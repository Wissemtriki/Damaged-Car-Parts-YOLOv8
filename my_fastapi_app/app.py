...
interpreter = tf.lite.Interpreter(model_path="E:/Damaged-Car-parts-prediction-using-YOLOv8-main/Damaged-Car-parts-prediction-using-YOLOv8-main/tflite_models/model.tflite")
